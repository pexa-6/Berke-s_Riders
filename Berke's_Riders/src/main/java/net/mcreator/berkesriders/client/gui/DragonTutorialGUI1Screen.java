...
public class DragonTutorialGUI1Screen extends AbstractContainerScreen<DragonTutorialGUI1Menu> {
	...
	public void init() {
		super.init();
		imagebutton_arrow_right = new ImageButton(this.leftPos + 235, this.topPos + 145, 16, 16, 0, 0, 16, new ResourceLocation("berkes_riders:textures/screens/atlas/imagebutton_arrow_right.png"), 16, 32, e -> {
			if (true) {
