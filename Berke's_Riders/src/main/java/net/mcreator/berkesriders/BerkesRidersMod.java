package net.mcreator.berkesriders;
...
@Mod("berkes_riders")
public class BerkesRidersMod {
	public static final Logger LOGGER = LogManager.getLogger(BerkesRidersMod.class);
	public static final String MODID = "berkes_riders";

	public BerkesRidersMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		BerkesRidersModSounds.REGISTRY.register(bus);
